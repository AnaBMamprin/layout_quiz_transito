...
public class Placa3 extends AppCompatActivity {
    ...
    private static final int botao_correto = R.id.btn4;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view.getId() == botao_correto) {
                    ...
                    Toast.makeText(Placa3.this, "Resposta Correta!", Toast.LENGTH_SHORT).show();
                } else {
                    // Resposta incorreta
                    view.setBackgroundColor(getResources().getColor(R.color.cor_vermelho));
                    Toast.makeText(Placa3.this, "Resposta Incorreta. Tente novamente.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
