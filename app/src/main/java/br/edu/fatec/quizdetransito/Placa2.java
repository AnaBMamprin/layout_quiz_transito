...
public class Placa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_placa2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view.getId() == botao_correto) {
                    ...
                    Toast.makeText(Placa2.this, "Resposta Correta!", Toast.LENGTH_SHORT).show();
                } else {
                    // Resposta incorreta
                    view.setBackgroundColor(getResources().getColor(R.color.cor_vermelho));
                    Toast.makeText(Placa2.this, "Resposta Incorreta. Tente novamente.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    public void proxima (View view){
        ...
        Intent it = new Intent(this, Placa3.class);
